...
git adalah aplikasi version-control dan code repository sedangkan `github` adalah sebuah layanan yang menyediakan infrastruktur untuk mengelola source code dengan menggunakan `git`.Kirim
